...
void setup()                    
{
	...
	for (n = 0; n < N_SENSORS; n++) {
		/* 
		 * releasedToApproachedTime is set to 10 ms by default. Set to
		 ...
		 * response time.
		 */
		cvdSensors.data[n].releasedToApproachedTime = 100;

		/*
		 * approachedToReleasedTime is set to 10 ms by default. Set to
		 * larger value to make sensor more robust against noise (at the
		 * cost of increasing the response time of the sensor).
		 */
		cvdSensors.data[n].approachedToReleasedTime = 100;
	}
}
